...
<script type="text/javascript" src="${ctx}/static/js/require.js" data-main="${ctx}/static/model/prodlib/show.js"></script>
</head>
<body>
	<div class="ds-main">
					...
					<ul class="form-list">
						<li>
							<div class="label">
								...
								<input type="text" class="required" style="width:200px;" id="name" name="name" readonly>
							</div>
						</li>
						<li>
							<div class="label">
								<span class="sm-title" style="min-width:100px;">规格：</span>
								<input type="text" class="required" style="width:200px;" id="spec" name="spec" readonly>
							</div>
						</li>
						<li>
							<div class="label">
								<span class="sm-title" style="min-width:100px;">品级：</span>
								<input type="text" class="required" style="width:200px;" id="grade" name="grade" readonly>
							</div>
						</li>
						<li>
							<div class="label">
								<span class="sm-title" style="min-width:100px;">产品标准号：</span>
								<input type="text" class="required" style="width:200px;" id="stdNum" name="stdNum" readonly>
							</div>
						</li>
						<li>
							<div class="label">
								<span class="sm-title" style="min-width:100px;">定点生产证号：</span>
								<input type="text" class="required" style="width:200px;" id="licenseNum" name="licenseNum" readonly>
							</div>
						</li>
						<li>
							<div class="label">
								<span class="sm-title" style="min-width:100px;">产地：</span>
								<input type="text" class="required" style="width:200px;" id="producePlace" name="producePlace" readonly>
							</div>
						</li>
						<li class="li-per">
							<div class="label">
								<span class="sm-title" style="min-width:100px;">产品有效期：</span>
								<input type="text" class="required" style="width:200px;" id="valtDateFrom" name="valtDateFrom" disabled>
								<span> 至 </span>  
								<input type="text" class="required" style="width:200px;" id="valtDateTo" name="valtDateTo" disabled>
							</div>
						</li>
						<li>
							<div class="label">
								<span class="sm-title" style="min-width:100px;">数量：</span>
								<input type="text" class="required" style="width:200px;" id="number" name="number" readonly>
							</div>
						</li>
						<li>
							<div class="label">
								<span class="sm-title" style="min-width:100px;">报价（元/kg）：</span>
								<input type="text" class="required" style="width:200px;" id="price" name="price" readonly>
							</div>
						</li>
						<li>
							<div class="label">
								<span class="sm-title" style="min-width:100px;">交割地：</span>
								<input type="text" class="required" style="width:200px;" id="deliveryPlace" name="deliveryPlace" readonly>
							</div>
						</li>
						<li class="li-per">
							<div class="label">
								<span class="sm-title" style="min-width:100px;">配料：</span>
								<textarea name="mixIngt" id="mixIngt" rows="2" id="mixIngt" name="mixIngt" readonly></textarea>
							</div>
						</li>
						<li class="li-per">
							<div class="label">
								<span class="sm-title" style="min-width:100px;">贮存：</span>
								<textarea name="keep" id="keep" rows="2" id="keep" name="keep" readonly></textarea>
							</div>
						</li>
						<li class="li-per">
							<div class="label">
								<span class="sm-title" style="min-width:100px;">营养成分：</span>
								<textarea name="nutrComp" id="nutrComp" rows="2" id="nutrComp" name="nutrComp" readonly></textarea>
							</div>
						</li>
						<li class="li-per">
							<div class="label">
								<span class="sm-title" style="min-width:100px;">产品介绍：</span>
								<textarea name="introduce" id="introduce" rows="2" id="introduce" name="introduce" readonly></textarea>
							</div>
						</li>
						<li class="li-per">
							<div class="label">
						...
						<li class="li-per">
							<div class="label">
								...
								<textarea name="antiFake" id="antiFake" rows="2" id="antiFake" name="antiFake" readonly></textarea>
							</div>
						</li>
						<li class="li-per">
							<div class="label">
