...
<body>
	<script src="../static/js/require.js" data-main="${ctx}/static/model/policies/policiesList.js"></script>
					...
					{#template MAIN}
						{#if $T.totalRow>0}
							{#foreach $T.data as row}
								<li>
									<a href="/policies/detail?id={$T.row.id}" target="_blank" class="content-item-title inline-block">{$T.row.title}</a>
