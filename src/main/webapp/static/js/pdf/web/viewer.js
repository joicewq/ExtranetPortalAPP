...
var PDFViewerApplication = {
  ...
  load: function pdfViewLoad(pdfDocument, scale) {
    ...
    pdfDocument.getMetadata().then(function(data) {
      ...
      window.parent.document.getElementById("viewpdf").style.height = document.getElementById("viewer").offsetHeight  + "px";
      
      //console.log("after",document.getElementById("viewer").offsetHeight);
