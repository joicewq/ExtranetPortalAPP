	...
	<![CDATA[
             <div class="ds-page clearfix">                 
                     ...
                     <ul>
						...
						{#if $T.curPage>1}
						<li><a href="javascript:pager.showDeafaultTable(1,{$T.pageLine});">首页</a></li>
						{#else}{* 没有上一页*}
							<li><a href="javascript:void(0);">首页</a></li>
						{#/if}					  
		              
					  	{#if $T.curPage>1}
							<li><a href="javascript:pager.showDeafaultTable({$T.curPage-1},{$T.pageLine});">上一页</a></li>
						{#else}{* 没有上一页*}
						...
						{#if $T.curPage==$T.totalPage &&$T.totalPage>2}{*如果本页等于最后页,总数大于2,补上倒数第三页*}
							<li><a onclick="javascript:pager.showDeafaultTable({$T.curPage-2},{$T.pageLine});">{$T.curPage-2}</a></li>
						{#/if}

					  	{#if $T.curPage>1}{*如果本页大于1,那么显示前一页*}
							<li><a onclick="javascript:pager.showDeafaultTable({$T.curPage-1},{$T.pageLine});">{$T.curPage-1}</a></li>
						{#/if}
					  <li><a  class="active">{$T.curPage}</a></li>{*显示当前页*}
						...
						{#/if}
					  	...
					  	{#if $T.curPage<$T.totalPage}
							<li><a href="javascript:pager.showDeafaultTable({$T.curPage+1},{$T.pageLine});">下一页</a></li>
						{#else}{* 没有下一页*}
							<li><a href="javascript:void(0);">下一页</a></li>
						{#/if}
					  	{#if $T.curPage<$T.totalPage}
							<li><a href="javascript:pager.showDeafaultTable({$T.totalPage},{$T.pageLine});">尾页</a></li>
						{#else}{* 没有下一页*}
                    ...
                    <li>页</li>
                    <li><a onclick="javascript:pager.showDeafaultTable($('#pageNum').val(),{$T.pageLine})" class="active hover">确定</a></li>
	              </ul>
